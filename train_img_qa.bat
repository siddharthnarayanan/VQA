...
..\bin\WordHash.exe --seqfea2bin  dssm\train.ans_plus_ques.src.fea.full 1024 dssm\train.ans_plus_ques.src.fea.full.bin
..\bin\WordHash.exe --seqfea2bin  dssm\train.img.src.fea.full 1024 dssm\train.img.src.fea.full.bin
...
REM cdssm training
..\bin\DSSM_Train.exe I_QA.config.txt
